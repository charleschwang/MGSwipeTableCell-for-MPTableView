...
-(instancetype) initWithReuseIdentifier:(NSString *)reuseIdentifier
{
    if (self = [super initWithReuseIdentifier:reuseIdentifier]) {
        ...
        [self addSubview:_mailFrom];
        [self addSubview:_mailMessage];
        [self addSubview:_mailSubject];
        [self addSubview:_mailTime];
...
-(void) layoutSubviews
{
    ...
    CGFloat textWidth = self.bounds.size.width - leftPadding * 2;
    ...
    CGFloat messageHeight = self.bounds.size.height - (_mailSubject.frame.origin.y + _mailSubject.frame.size.height) - topPadding * 2;
    ...
    frame.origin.x = self.frame.size.width - leftPadding - dateWidth;
