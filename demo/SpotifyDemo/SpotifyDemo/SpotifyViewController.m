...
- (MPTableViewCell *)MPTableView:(MPTableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        cell = [[MGSwipeTableCell alloc] initWithReuseIdentifier:identifier];
        textLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, tableView.frame.size.width / 3, 50)];
        textLabel.tag = 250;
        [cell addSubview:textLabel];
        
        detailTextLabel = [[UILabel alloc] initWithFrame:CGRectMake(textLabel.frame.size.width, 0, tableView.frame.size.width / 3 * 2, 50)];
        detailTextLabel.tag = 251;
        [cell addSubview:detailTextLabel];
        
        textLabel.font =  [UIFont fontWithName:@"HelveticaNeue-Light" size:21.0f];
        textLabel.textColor = [UIColor colorWithRed:152/255.0 green:152/255.0 blue:157/255.0 alpha:1.0];
        textLabel.font =  [UIFont fontWithName:@"HelveticaNeue-Light" size:17.0f];
        ...
        cell.selectionColor = nil;
        
        UIImageView * view = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"more.png"]];
        view.contentMode = UIViewContentModeScaleAspectFit;
        view.frame = CGRectMake(tableView.frame.size.width - 30, 12.5, 25, 25);
    ...
    detailTextLabel.text = data.album;
    return cell;
}
